...
参数 | 参数名称 | 类型 | 必填|描述 |范例
--------- | ------ | ----- | -------|---|----
terminal_sn	|合码云终端ID| String(32)|Y|合码云终端ID|"00101010029201012912"
sn|	合码云唯一订单号|	String(16)|N|合码云系统内部唯一订单号|"7892259488292938"
...
terminal_sn	|合码云终端ID|	String(32)|	Y	|合码云终端ID，可使用英文字母和数字	| "103939292020"
...
finish_time	|退款动作在合码云的完成时间|	String(13)|	Y	|时间戳，本次退款动作在合码云的完成时间| "1449646835244"
